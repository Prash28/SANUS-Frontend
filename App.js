...
<img src={heart} alt="Cardio Exam"/> 
  ...
  <div className="content text-center   with_button ">
    ...
    <div className="link centered">
        <a href="http://192.168.1.2/heart/test"  target="" className="btn btn-xs btn-primary"><strong>Analyze</strong></a>
    </div>
...
<div className="wpb_column vc_column_container col-sm-12 col-md-4 text-left" data-aos="fade-left" data-aos-duration ="10000" data-aos-delay="1000">
<div className="wpb_wrapper">
